...
class RedsysHelperTest < Test::Unit::TestCase
  ...
  def setup
    ...
    @helper = Redsys::Helper.new('070803113316', 'Comercio Pruebas',
      :amount   => 825,
      :currency => 'EUR'
    )
    @helper.description = "Alfombrilla para raton"
    @helper.customer_name = "Redsys"
  ...
  def test_credentials_overwritable
    @helper = Redsys::Helper.new(29292929, 'cody@example.com',
      :amount => 1235,
      :currency => 'EUR',
